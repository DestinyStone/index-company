    ...
    <div style="width: 70%;">
      <regard-we-title title="企业介绍">
        <div style="display: flex; height: 350px;">
          ...
          <div>
            <el-image style="height: 350px; width: 415px;" src="v2_rjfamu.png"></el-image>
          </div>
        </div>
      </regard-we-title>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        journalHeight: 0,
        mainJournalData: {imgSrc: "v2_rjfds3.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
        journalData: [
          {imgSrc: "v2_rjfdzo.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
          {imgSrc: "v2_rjfdzo.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
          {imgSrc: "v2_rjfdzo.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
          {imgSrc: "v2_rjfdzo.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
          {imgSrc: "v2_rjfdzo.png", title: "2022年集中式交易型数据库采购项目", mainContent: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", year: "2022", time: "09-10"},
